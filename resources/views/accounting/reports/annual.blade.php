        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="bg-white p-3 rounded-3 shadow-sm border">
                <form method="GET" class="d-flex align-items-center gap-3">
                    ...
                    <select name="year" class="form-select form-select-sm border-2" onchange="this.form.submit()"
                ...
                <div class="card h-100 border-0 shadow-sm hover-card">
                    <div class="card-body p-3">
                        <div class="d-flex flex-column text-center">
                            <div class="mb-2">
                                <div
                                    class="bg-{{ $totalYearBalance >= 0 ? 'primary' : 'secondary' }} bg-opacity-10 p-3 rounded-3 d-inline-block">
                                    <i
                                        class="fas fa-wallet text-{{ $totalYearBalance >= 0 ? 'primary' : 'secondary' }} fs-5"></i>
                                </div>
                            </div>
                            <div>
                                <p class="text-secondary mb-1 fw-semibold small">Saldo Akhir Tahun</p>
                                <h6 class="text-{{ $totalYearBalance >= 0 ? 'primary' : 'secondary' }} fw-bold mb-0"
                            ...
                            <nav class="nav nav-pills nav-fill">
                                @foreach ($quarters as $q => $transactions)
                                    <a class="nav-link {{ $loop->first ? 'active' : '' }} border-0 rounded-0 py-3"
                                        id="tab-{{ Str::slug($q) }}" data-bs-toggle="pill"
                                        href="#content-{{ Str::slug($q) }}" role="tab">
                                                        ...
                                                        @foreach ($transactions->sortBy('date') as $t)
                                                            <tr class="border-bottom-light">
                                                                ...
                                                                <td class="py-3">
                                                                    @if ($t->type === 'income')
                                                                        <span
                                                                            class="badge bg-success bg-opacity-75 px-3 py-2">
                                                                            <i class="fas fa-arrow-up me-1"></i>Pemasukan
                                                                        </span>
                                                                    @elseif($t->type === 'expense')
                                                                        <span
                                                                            class="badge bg-danger bg-opacity-75 px-3 py-2">
                                                                            <i
                                                                                class="fas fa-arrow-down me-1"></i>Pengeluaran
                                                                        </span>
                                                                    @elseif($t->type === 'loan')
                                                                        <span
                                                                            class="badge bg-info bg-opacity-75 px-3 py-2">
                                                                ...
                                                                <td class="py-3 text-end">
                                                                    <span
                                                                        class="fw-bold text-{{ $t->type === 'income' ? 'success' : ($t->type === 'loan' ? 'info' : 'danger') }}">
                                                                        {{ $t->type === 'income' ? '+' : '-' }} Rp
