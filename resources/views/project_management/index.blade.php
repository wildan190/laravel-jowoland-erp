                    ...
                    @forelse ($projects as $project)
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="progress flex-grow-1" style="height: 18px;">
                                        <div class="progress-bar 
                                            {{ $project->progress_percentage < 40 ? 'bg-danger' : ($project->progress_percentage < 70 ? 'bg-warning' : 'bg-success') }}"
                                            role="progressbar"
                            ...
                            <td class="text-center" style="white-space: nowrap;">
                                ...
                                <a href="{{ route('projects.calendar', $project) }}" class="btn btn-sm btn-secondary me-1">
