                ...
                <form action="{{ route('payrolls.update', $payroll) }}" method="POST">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="fa fa-exclamation-triangle me-1"></i> Mohon perbaiki kesalahan berikut:
                            <ul class="mb-0">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="basic_salary" type="number" class="form-control" value="{{ $payroll->employee->salary }}" readonly>
                    </div>

                    {{-- Tunjangan --}}
                    <div class="mb-3">
                        <label class="form-label">Tunjangan</label>
                        <input type="number" name="allowance" class="form-control @error('allowance') is-invalid @enderror"
                            value="{{ old('allowance', $payroll->allowance) }}" required>
                        @error('allowance')
